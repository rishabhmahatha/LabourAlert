...
class Top10StateListAdapter(
    private val context: Context,
    private val onItemClick: OnItemClick,
    private val arrTop10List: ArrayList<DataModel._1_>
) : RecyclerView.Adapter<Top10StateListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: Top10StateListAdapter.MyViewHolder, position: Int) {
        holder.tvSNo!!.text = (position + 1).toString()
        holder.tvName!!.text = arrTop10List[position].state
        ...
        holder.ivNotificationIcon!!.setOnClickListener { p0 -> onItemClick.onSaveStateAlertClick(position, p0) }
    ...
    interface OnItemClick {
        fun onSaveStateAlertClick(position: Int, view: View)
    }
}