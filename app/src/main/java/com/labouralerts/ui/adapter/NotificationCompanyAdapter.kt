...
class NotificationCompanyAdapter(
    private val context: Context,
    private val arrNotificationList: ArrayList<DataModel.NotificationCompany>
) : RecyclerView.Adapter<NotificationCompanyAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NotificationCompanyAdapter.MyViewHolder, position: Int) {
